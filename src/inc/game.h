...
// holds information about each glyph
glyph_metrics_t glyph_metrics_cache[GLYPH_AMOUNT];
...
// NOTE(Rami): our implementation, remove this line later
SDL_Texture* create_texture_atlas(SDL_Renderer *renderer, TTF_Font *font);
// NOTE(Rami): SDLs iplementation, remove this line later
