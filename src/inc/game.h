...
extern void generate_dungeon(unsigned char *map, int map_width, int map_height, int room_count, entity_t* player);
extern void initialize_map(unsigned char *map, int map_width, int map_height);
extern void initialize_and_place_rooms(unsigned char *map, int map_width, int map_height, int room_count, room_t *rooms);
extern void connect_rooms(unsigned char *map, int map_width, int room_count, room_t *rooms);
extern void place_corridors(unsigned char *map, int map_width, room_t room_a, room_t room_b, int direction);
extern int is_room_valid(unsigned char *map, room_t room, int map_width);
