...
internal void add_player_starting_item(RandomState *random, Item *items, ItemInfo *item_info, Inventory *inventory, ItemID id, u32 x, u32 y);
...
internal Item *add_weapon_item(RandomState *random, Item *items, ItemID id, ItemRarity rarity, u32 x, u32 y);
internal Item *add_armor_item(RandomState *random, Item *items, ItemID id, u32 x, u32 y);
internal Item *add_consumable_item(RandomState *random, Item *items, ItemInfo *item_info, ItemID id, u32 x, u32 y);